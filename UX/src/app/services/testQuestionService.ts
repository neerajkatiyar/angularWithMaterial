            ...
            "formGroupInfo":{
               ...
               "renderingInfo":{
                  "products":{
                     ...
                     "controlType":"custom",
                     "dataType":"products",
                     "visibility":"this.form.controls.firstName.value == \"products\"",
                     "disabled":"!this.form.controls.emailAddress.value"
                  },
                  "braveryRating":{
                     "order":3
                  },
            ...
            "product":{
               "formGroupInfo":{
                  ...
                  "renderingInfo":{
                     "importedDate":{
                        "order":3,
                        "visibility":"this.form.controls.imported.value == true",
                        "disabled":"this.form.controls.name.value  == ''"
                     },
                     "name":{
                        "order":1
                     },
